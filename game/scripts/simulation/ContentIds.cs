...
public static class ContentIds
{
    ...
    {
        public const string PlayerExpedition = "faction_player_expedition";
        public const string PrivateMilitary = "faction_private_military";
    }

    public static class Units
    {
        public const string Grunt = "unit_grunt";
