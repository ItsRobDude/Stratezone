...
internal static class ContentSmoke
{
    public static void Run(SmokeTestContext context)
    {
        ...
        Assert(localization.Translate("ui.tooltip.resource.materials").Contains("Materials stockpile", StringComparison.Ordinal), "English localization catalog loads HUD tooltip strings");
